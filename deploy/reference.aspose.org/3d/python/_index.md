...
| Class | Description |
|---|---|
| `Camera` | Camera entity. Stores projection type, field of view, near and far clip distances, and aspect ratio. Attached to a `Node` to define viewpoint transforms. |
| `Light` | Light-source entity. Stores light type, colour, intensity, and attenuation parameters. |
