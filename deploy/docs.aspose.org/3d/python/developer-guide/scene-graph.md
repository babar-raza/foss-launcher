...
No native extensions, compilers, or additional system packages are required. For full installation instructions, see the [Installation Guide](../getting-started/installation/).
