...
- [Getting Started](../getting-started/) — prerequisites, installation, and first steps
- [Installation](../getting-started/installation/) — pip install and optional dependencies
