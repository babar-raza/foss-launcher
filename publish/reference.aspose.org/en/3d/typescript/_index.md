...
canonical: https://reference.aspose.org/3d/typescript/
url: /reference.aspose.org/3d/typescript/
date: '2026-01-20'
...
robots: index, follow
seoTitle: "Aspose.3D FOSS for TypeScript API Reference — @aspose/3d v24.12.0"
weight: 1
draft: false
type: reference_home
keywords:
  - aspose 3d typescript api
  - aspose 3d class reference
  - 3d nodejs api reference
  - "@aspose/3d classes"
---
...
- [Knowledge Base: How-To Guides](/kb.aspose.org/3d/typescript/)
- [Detailed API Overview](/reference.aspose.org/3d/typescript/api-overview/)
- [Scene class](/reference.aspose.org/3d/typescript/scene/)
- [Node class](/reference.aspose.org/3d/typescript/node/)
- [Mesh class](/reference.aspose.org/3d/typescript/mesh/)
