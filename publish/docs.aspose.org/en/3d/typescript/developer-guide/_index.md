...
If you have not yet installed the library, see the [Getting Started](/docs.aspose.org/3d/typescript/getting-started/) section and the [Installation](/docs.aspose.org/3d/typescript/getting-started/installation/) guide before reading further.
