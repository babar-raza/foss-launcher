...
GROUPS: tuple[PackGroup, ...] = (
    ...
    PackGroup(
        ...
        files=(
            ...
            "src/launch/orchestrator/phase_executor.py",
            "src/launch/orchestrator/phase_verifier.py",
            "src/launch/orchestrator/run_loop.py",
            "src/launch/validation_engine/adapters.py",
            "src/launch/validation_engine/context.py",
            ...
            "src/launch/validation_engine/runner.py",
            ...
            "src/launch/io/run_layout.py",
            "src/launch/io/run_lock.py",
            "src/launch/monitoring/event_tailer.py",
            ...
            "src/launch/state_store/store.py",
    ...
    PackGroup(
        ...
        files=(
            "src/launch/workers/_shared/**",
            "src/launch/workers/_git/**",
            "src/launch/workers/w1_repo_scout/**",
            "src/launch/workers/w2_facts_builder/**",
            "src/launch/workers/w3_snippet_curator/**",
            "src/launch/workers/w4_ia_planner/**",
            "src/launch/workers/w5_section_writer/**",
            "src/launch/workers/w6_seo_optimizer/**",
    ...
    generated.append(
        (
            ...
            textwrap.dedent(
                ...
                6. `CONFIG_MAP.md`
                7. `TREE.txt`
                8. `src/launch/cli/main.py`
                9. `src/launch/orchestrator/run_loop.py`
                10. `src/launch/validation_engine/runner.py`

                Mental model:
                - `launch` is the operator-facing front door.
                - `src/launch/orchestrator/graph.py` is the runtime state machine.
                ...
                - `src/launch/workers/` contains the actual producer/fixer implementations where many defects originate.
    ...
    generated.append(
        (
            ...
            textwrap.dedent(
                ...
                Entrypoints:
                - `launch` -> `src/launch/cli/main.py`
                - `launch_validate` -> `src/launch/validators/cli.py`
                ...
                - Validation registry: `src/launch/validation_engine/gates_registry.yaml`
                - Concrete worker implementations: `src/launch/workers/`
                """
            ),
        )
    )
    ...
    generated.append(
        (
            ...
            textwrap.dedent(
                ...
                - `src/launch/orchestrator/run_loop.py`
                - `src/launch/validation_engine/runner.py`
                - Downstream repair targets in `src/launch/workers/` (especially W5-W10)
                ...
                - `write_heal_plan()`
                - `run_heal_loop()`
                - `recommend_action()` in `src/launch/cli/triage.py`
                """
            ),
        )
    )
        ...
        (
            ...
            textwrap.dedent(
                ...
                2. Per-run content validation
                   ...
                   - Runtime: `src/launch/validators/cli.py` -> `src/launch/validation_engine/runner.py`
                   - Registry: `src/launch/validation_engine/gates_registry.yaml`
                   - Registry gate count: {gate_count}
                   - Output: `runs/<run_id>/artifacts/validation_report.json`
                   - Concrete gate implementations are copied under `src/launch/workers/w9_validator/gates/`
                ...
                - `src/launch/cli/triage.py` ranks issues and suggests a resume worker.
                - `src/launch/cli/heal.py` executes the repair and compares the next report to the previous one.
    ...
    generated.append(
        (
            ...
            textwrap.dedent(
                ...
                - `specs/pilots/*/run_config.pinned.yaml`: binding pilot configs
                - `specs/schemas/*.json`: runtime artifact contracts
                - `src/launch/validation_engine/gates_registry.yaml`: declarative validation behavior
        ...
        (
            ...
            textwrap.dedent(
                ...
                **Source code (where defects originate and are fixed):**
                - `src/launch/workers/w2_facts_builder/extract_claims.py` — claim visibility
                - `src/launch/workers/w4_ia_planner/worker.py` — claim scoping + affinity
                - `src/launch/workers/w5_section_writer/` — content generation (skeletons, imports, cache)
                - `src/launch/workers/w7_content_reviewer/` — semantic accuracy checks
                - `src/launch/workers/w9_validator/gates/` — all 50 validation gates
                - `src/launch/workers/w10_fixer/worker.py` — auto-fix dispatch
                - `src/launch/workers/_shared/content_sanitizer.py` — shared content cleaning
