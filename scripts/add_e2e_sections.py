...
TASKCARD_E2E_DATA = {
    ...
    "TC-400": {
        ...
        "artifacts": [
            ...
            "artifacts/frontmatter_contract.json (schema: frontmatter_contract.schema.json)",
            "artifacts/site_context.json (schema: site_context.schema.json)",
        ],
        "success": ["repo_inventory.json validates", "frontmatter_contract.json validates", "site_context.json validates"],
        "upstream": "TC-300 (orchestrator dispatches W1)",
        "downstream": "TC-410 (W2 FactsBuilder), TC-420 (W3 Snippets)",
        "contracts": "repo_inventory.schema.json, frontmatter_contract.schema.json, site_context.schema.json",
    },
    "TC-401": {
    ...
    "TC-402": {
        ...
        "contracts": "repo_inventory.schema.json",
    },
    "TC-403": {
    ...
    "TC-411": {
        "e2e_command": "python -m launch.workers.w2_facts_builder.extract --repo-inventory artifacts/repo_inventory.json",
        "artifacts": [
