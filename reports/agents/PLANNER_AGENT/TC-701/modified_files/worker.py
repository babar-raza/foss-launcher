...
def compute_output_path(
    ...
    slug: str,
    family: str,
    subdomain_roots: Dict[str, str] = None,
    platform: str = "python",
    locale: str = "en",
) -> str:
    """Compute content file path relative to site repo root.

    TC-701: V2 layout with family-aware paths:
    ...
    Args:
        section: Section name (products, docs, reference, kb, blog)
        slug: Page slug
        family: Product family (e.g., "3d", "note", "cells")
        subdomain_roots: Optional dict mapping section -> subdomain path
        platform: Platform (e.g., "python", "java")
    ...
    """
    # Get subdomain root from subdomain_roots mapping or default
    if subdomain_roots and section in subdomain_roots:
        subdomain_root = subdomain_roots[section]
    else:
        # Fall back to legacy get_subdomain_for_section
        subdomain = get_subdomain_for_section(section)
        subdomain_root = f"content/{subdomain}"

    # Blog section has special path format (no locale, bundle-style)
    if section == "blog":
        return f"{subdomain_root}/{family}/{platform}/{slug}/index.md"
    else:
        # All other sections: content/<subdomain>/<family>/<locale>/<platform>/<slug>.md
        return f"{subdomain_root}/{family}/{locale}/{platform}/{slug}.md"
...
def plan_pages_for_section(
    ...
    TC-701: Updated to accept family and subdomain_roots for V2 path construction.
    ...
    if section == "products":
        ...
        pages.append({
            "section": section,
            "slug": slug,
            "output_path": compute_output_path(section, slug, family, subdomain_roots=subdomain_roots, platform=platform, locale=locale),
            "url_path": compute_url_path(section, slug, family, platform=platform, locale=locale),
            "title": title,
            "purpose": purpose,
            ...
            "seo_keywords": [family, platform, "overview"],
            "forbidden_topics": []
        })
        ...
        pages.append({
            ...
            "output_path": compute_output_path(section, "getting-started", family, subdomain_roots=subdomain_roots, platform=platform, locale=locale),
            "url_path": compute_url_path(section, "getting-started", family, platform=platform, locale=locale),
            ...
            "cross_links": [],
            "seo_keywords": [family, platform, "getting started"],
            "forbidden_topics": []
        })
        ...
        for i, workflow in enumerate(workflows[:max_pages - 1]):
            ...
            pages.append({
                ...
                "required_snippet_tags": snippet_tags[:2] if snippet_tags else [],
                "cross_links": [],
                "seo_keywords": [family, platform, slug],
                "forbidden_topics": []
            })
        ...
        pages.append({
            ...
            "required_snippet_tags": snippet_tags[:1] if snippet_tags else [],
            "cross_links": [],
            "seo_keywords": [family, platform, "api", "reference"],
            "forbidden_topics": []
        })
        ...
        if launch_tier in ["standard", "rich"]:
            ...
            for module in modules:
                ...
                pages.append({
                    ...
                    "required_snippet_tags": snippet_tags[:1] if snippet_tags else [],
                    "cross_links": [],
                    "seo_keywords": [family, platform, module],
                    "forbidden_topics": []
                })
        ...
        pages.append({
            "section": "kb",
            "slug": "faq",
            "output_path": compute_output_path("kb", "faq", family, subdomain_roots=subdomain_roots, platform=platform, locale=locale),
            "url_path": compute_url_path("kb", "faq", family, platform=platform, locale=locale),
            ...
            "cross_links": [],
            "seo_keywords": [family, platform, "faq"],
            "forbidden_topics": []
        })
        ...
        if launch_tier in ["standard", "rich"]:
            pages.append({
                ...
                "output_path": compute_output_path("kb", "troubleshooting", family, subdomain_roots=subdomain_roots, platform=platform, locale=locale),
                "url_path": compute_url_path("kb", "troubleshooting", family, platform=platform, locale=locale),
                ...
                "required_snippet_tags": [],
                "cross_links": [],
                "seo_keywords": [family, platform, "troubleshooting"],
                "forbidden_topics": []
            })
            ...
            pages.append({
                "section": "kb",
                "slug": "limitations",
                "output_path": compute_output_path("kb", "limitations", family, subdomain_roots=subdomain_roots, platform=platform, locale=locale),
                "url_path": compute_url_path("kb", "limitations", family, platform=platform, locale=locale),
                ...
                "required_snippet_tags": [],
                "cross_links": [],
                "seo_keywords": [family, platform, "limitations"],
                "forbidden_topics": []
            })
        ...
        pages.append({
            "section": "blog",
            "slug": "announcement",
            "output_path": compute_output_path("blog", "announcement", family, subdomain_roots=subdomain_roots, platform=platform, locale=locale),
            "url_path": compute_url_path("blog", "announcement", family, platform=platform, locale=locale),
            ...
            "required_snippet_tags": snippet_tags[:1] if snippet_tags else [],
            "cross_links": [],
            "seo_keywords": [family, platform, "announcement"],
            "forbidden_topics": []
        })
...
def execute_ia_planner(
    ...
    try:
        ...
        # TC-701: Get family and platform from run_config
        ...
        family = getattr(run_config_obj, "family", product_facts.get("product_slug", "product"))
        platform = getattr(run_config_obj, "target_platform", "python")
        locale = getattr(run_config_obj, "locale", "en")

        # TC-701: Build subdomain_roots mapping for V2 layout
        subdomain_roots = {
        ...
        for section in sections:
            section_pages = plan_pages_for_section(
                ...
                snippet_catalog=snippet_catalog,
                family=family,
                subdomain_roots=subdomain_roots,
                platform=platform,
                locale=locale,
            )
        ...
        page_plan = {
            "schema_version": "1.0",
            "product_slug": family,  # TC-701: Using family for consistency
            "launch_tier": launch_tier,
