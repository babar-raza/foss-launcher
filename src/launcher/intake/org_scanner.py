...
Spec reference: specs/github_intake.md  Section 4
"""
...
def scan_org(
    ...
    *,
    ...
    Args:
        ...
        seen_repos: Set of repo full_names already scanned (skipped unless force_rescan=True).
        force_rescan: When True, repos already in seen_repos are NOT skipped.
                      Use this to re-evaluate previously-classified repos.
    ...
    while url and pages_fetched < max_pages:
        ...
        for repo in repos:
            ...
            # TC-4073: force_rescan bypasses the seen_repos skip so previously-classified
            # repos can be re-evaluated (e.g. when eligibility rules change).
...
def scan_orgs(
    ...
    *,
    ...
    # Persist state (atomic write for crash safety)
