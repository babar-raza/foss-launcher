...
Example: "TC-XXX modifies validate_secrets_hygiene.py to implement whitelist-based scanning for performance optimization while maintaining security coverage."
...
- Agent report at reports/agents/<agent>/TC-XXX/report.md
- Self-review at reports/agents/<agent>/TC-XXX/self_review.md
