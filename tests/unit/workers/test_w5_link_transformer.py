...
def test_transform_blog_to_docs_link():
    ...
    content = "See the [Getting Started Guide](../../docs/3d/getting-started/)."
    page_metadata = {
        "locale": "en",
        "family": "3d",
    }
    ...
    assert "https://docs.aspose.org/3d/getting-started/" in result
...
def test_transform_docs_to_reference_link():
    ...
    content = "See the [API Reference](../../reference/cells/api/)."
    page_metadata = {
        "locale": "en",
        "family": "cells",
    }
    ...
    # Should transform to absolute URL
    assert "https://reference.aspose.org/cells/api/" in result
...
def test_transform_kb_to_docs_link():
    ...
    content = "Follow the [installation tutorial](../../docs/cells/installation/)."
    page_metadata = {
        "locale": "en",
        "family": "cells",
    }
    ...
    # Should transform to absolute URL
    assert "https://docs.aspose.org/cells/installation/" in result
...
def test_transform_multiple_links():
    ...
    content = """
See the [Getting Started](../../docs/3d/getting-started/) guide.
Check the [API Reference](../../reference/3d/api/) for details.
...
"""
    ...
    assert "https://reference.aspose.org/3d/api/" in result
...
def test_transform_docs_to_docs_link_not_transformed():
    ...
    content = "See [Another Guide](../../docs/cells/another-guide/)."
    page_metadata = {
        "locale": "en",
        "family": "cells",
    }
...
def test_transform_section_index_link():
    ...
    content = "Visit [Docs Home](../../docs/3d/)."
    page_metadata = {
        "locale": "en",
        "family": "3d",
    }
    ...
    assert "https://docs.aspose.org/3d/" in result
    assert "[Docs Home]" in result


def test_transform_with_subsections():
    """Test link with nested subsections."""
    content = "See [Advanced Guide](../../docs/cells/developer-guide/advanced/features/)."
    page_metadata = {
        "locale": "en",
        "family": "cells",
    }
    ...
    assert "https://docs.aspose.org/cells/developer-guide/advanced/features/" in result
...
def test_transform_products_to_docs_link():
    ...
    content = "Read the [Documentation](../../docs/words/guide/)."
    page_metadata = {
        "locale": "en",
        "family": "words",
    }
