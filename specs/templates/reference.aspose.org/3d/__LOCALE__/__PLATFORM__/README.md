# V2 Platform-Aware Templates (reference)

This folder contains V2 (platform-aware) templates for the reference section.

## Layout version

- **V2**: `specs/templates/reference.aspose.org/<family>/<locale>/<platform>/...`
