---
# Template: format detail page (layout: "plugin")
# Source pattern: content/products.aspose.org/{family}/{locale}/{converter}/{format}.md
...
single:
  enable: __SINGLE_ENABLE__
  block:
    - title: "__SINGLE_TITLE__"
      content: |
        __SINGLE_CONTENT__
      gisthash: "__SINGLE_GIST_HASH__"
      gistfile: "__SINGLE_GIST_FILE__"
