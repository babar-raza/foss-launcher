...
# Source pattern: content/docs.aspose.org/cells/{locale}/{platform}/developer-guide/_index.md
...
For installation and basic setup, see [Getting Started](__URL_GETTING_STARTED__).
