# V2 Platform-Aware Templates (kb)

This folder contains V2 (platform-aware) templates for the knowledge base section.

## Layout version

- **V2**: `specs/templates/kb.aspose.org/<family>/<locale>/<platform>/...`
